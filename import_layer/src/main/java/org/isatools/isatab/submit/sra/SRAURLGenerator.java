...
public class SRAURLGenerator {
    ...
    private static SRAURLGenerator instance;
    static Logger logger = Logger.getLogger(SRAURLGenerator.class.getName( ));
    Appender appender;
    PatternLayout layout;

    public SRAURLGenerator(){
    ...
    public static synchronized SRAURLGenerator getInstance() {
        if (instance == null) {
            instance = new SRAURLGenerator();
        }
        return instance;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SRAURLGenerator eac = new SRAURLGenerator();
